...
const noParty: Person[] = [
  ...
  },
  {
    ...
    candidate: [
      {
        areaNumber: 11,
        role: '22 года. руководитель направления практических исследований в Воронеже, Фонд содействия развитию городов «Городские Проекты Ильи Варламова и Максима Каца»',
        project: Project.gorpr,
        callNumber: 5,
        locationType: LocationType.city,
        status: CandidateStatuses.declined,
