  ...
  city: {
    ...
    8: {
      ...
      streets: [
        ...
        'Новоусманская, Околицкая, Ольховая (Степная), Оранжевая (Садовая), Парусная, Пахотная, Первоцветная (Первомайская), Петровская, Пилотов, Подклетненская, Подлесная, Подольская, Полякова, Приморская, Проселочная (Железнодорожная), Радостная (Солнечная), Ратная (Лесная), Ровная, Рождественская (Луговая), Ростовская № 48/3, четные с № 50/3по № 86, нечетные с № 53 по № 73а;',
